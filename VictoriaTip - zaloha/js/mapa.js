function initMapa() {
    ...
    const detailyVelkychCasin = {
        ...
        135: { web: "https://casinolitomerice.cz/", fotka: "img/casino-litomerice.jpg" },
        122: { web: "https://www.casinosokolov.cz/", fotka: "img/casino-sokolov.jpg" }
    };
    ...
    fetch('pobocky.json')
        ...
        .then(responseJson => {
            ...
            serazenePobocky.forEach(pobocka => {
                ...
                const typTrida = pobocka.herna ? "type-herna" : "type-casino";
                ...
                const infoObsah = `
                    <div class="map-info-card">
                        ...
                        <div class="map-info-body">
                            <span class="map-info-tag ${typTrida}">${typProvozu}</span>
                            <h3>${pobocka.title}</h3>
                ...
                if (seznamGrid) {
                    ...
                    kartaPobocky.innerHTML = `
                        <span class="seznam-type-label ${typTrida}">${typProvozu}</span>
